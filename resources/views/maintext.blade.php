...
@section('header')
  <div id="block-header" class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
    <div class="">
      <h1 class="col-md-6 font-italic">Категория</h1>
      <p class="col-md-6 font-italic"><a href="{{asset('#')}}">К другим постам в категории</a></p>
...
@section('content')
      ...
      <div class="blog-post body-maintext">
        ...
        <p class="blog-post-meta">Автор: <a href="{{asset('user_id')}}">user_name</a></p>
